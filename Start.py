...
from modules.speedtest_module import select_speedtest
from modules.yt_saver_module import select_yt_saver
from modules.grader_module import select_grader
